...
public class TelaPontuacao extends javax.swing.JFrame {
     ...
     */
    public TelaPontuacao(Tela tela) {
        initComponents();
        this.setLocation(tela.getX()+tela.getWidth(), tela.getY());
        this.setSize(200, tela.getHeight());
    ...
    public void desenhaTela(String rankingJogo) {
        jTextArea1.setText(rankingJogo);
        this.repaint();
    }
